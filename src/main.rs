...
fn test_real_blocks() {
    ...
    assert!(check_hash(bitcoin::BlockHeader {
        version: 536870912,
        prev_blockhash: into("508ff5554dc9f83e3cab31b8fb89d10604ebcd963c7b8ce131fd3ef47c2a0921"),
    ...
    assert!(check_hash(bitcoin::BlockHeader {
        version: 536870912,
        prev_blockhash: into("4cb8068ec9d224d5869fe57144cff796e4c88f9da5ebe81dab88cd247d93e0e2"),
